  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-neutral-700">
        ...
        <section>
          <h2 className="text-lg font-semibold text-foreground">3. Your account and data</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-foreground">6. Disclaimer &amp; liability</h2>
          <p className="mt-2">
