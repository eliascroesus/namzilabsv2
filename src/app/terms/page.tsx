...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <h1 className="mt-6 text-display font-semibold tracking-tight text-foreground">Terms of Service</h1>
      <p className="mt-2 text-base text-neutral-500">Last updated: July 16, 2026</p>

      <div className="mt-8 space-y-6 text-neutral-700">
        <section>
          <h2 className="text-title font-semibold text-foreground">1. Acceptance of terms</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">2. The Service</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">3. Your account and data</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">4. Acceptable use</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">5. Termination</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">6. Disclaimer &amp; liability</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-title font-semibold text-foreground">7. Contact</h2>
          <p className="mt-2">
