...
export const FLOW_TEMPLATES: FlowTemplate[] = [
  {
    ...
    description:
      "How fast your team calls new leads: from a lead being created to its first outbound call, median across leads. Leads never called are counted and reported when you test, never folded in as a zero. Close's event log only reaches back about 30 days, so leads created before you connected aren't in it.",
    source: "close",
