...
WITH expected (tbl, col) AS (
  VALUES
    ...
    ('billing_subscriptions', 'interval'),
    ('billing_subscriptions', 'status'),
    ('billing_subscriptions', 'current_period_end'),
    ('billing_subscriptions', 'cancel_at_period_end'),
    ('billing_subscriptions', 'trial_end'),
    ('billing_subscriptions', 'amount_cents'),
    ...
    ('metrics', 'definition'),
    ('metrics', 'created_at'),
    ('plan_pauses', 'connection_id'),
    ('plan_pauses', 'org_id'),
    ('plan_pauses', 'paused_at'),
    ('promo_codes', 'id'),
    ('promo_codes', 'code'),
    ('promo_codes', 'plan'),
    ('promo_codes', 'months'),
    ('promo_codes', 'max_redemptions'),
    ('promo_codes', 'redeem_by'),
    ('promo_codes', 'note'),
    ('promo_codes', 'created_by'),
    ('promo_codes', 'created_at'),
    ('promo_codes', 'disabled_at'),
    ...
    ('tracking_links', 'id'),
    ('tracking_links', 'slug'),
    ('tracking_links', 'label'),
    ('tracking_links', 'source'),
    ('tracking_links', 'medium'),
    ('tracking_links', 'campaign'),
    ('tracking_links', 'destination'),
    ('tracking_links', 'created_by'),
    ('tracking_links', 'created_at'),
    ('tracking_links', 'archived_at'),
    ('trial_claims', 'user_id'),
    ('trial_claims', 'org_id'),
    ('trial_claims', 'plan'),
    ('trial_claims', 'claimed_at'),
    ('usage_ledger', 'id'),
    ('usage_ledger', 'org_id'),
    ...
    ('workspace_acquisitions', 'org_id'),
    ('workspace_acquisitions', 'link_id'),
    ('workspace_acquisitions', 'source'),
    ('workspace_acquisitions', 'medium'),
    ('workspace_acquisitions', 'campaign'),
    ('workspace_acquisitions', 'clicked_at'),
    ('workspace_acquisitions', 'created_at'),
...
WITH expected (tbl, idx) AS (
  VALUES
    ...
    ('plan_pauses', 'plan_pauses_org_idx'),
